...
export type Member = { login: string; name?: string }

export type Config = {
  upstream: string
  forkRepoName: string
  notion: {
    properties: { status: string; prUrl: string; syncKey: string; date: string }
...
export type Action =
  | { kind: 'create'; key: string; title: string; status: string; prUrl: string; date: string }
